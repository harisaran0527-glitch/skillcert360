...
export default async function StudentsPage({
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      {edited && (
        <div className="rounded-2xl border border-indigo-500/40 bg-indigo-500/15 p-4 text-xs font-semibold text-indigo-300">
      ...
      <div className="glass-panel rounded-3xl p-6 space-y-5 border border-slate-800">
        ...
        <form action="/api/admin/students" method="post" className="space-y-4 text-xs">
          {/* Row 1: Full Name | Register Number | Email Address */}
          ...
          {/* Row 2: Department | Section | Academic Year | Account Status */}
      ...
      {/* ── BOTTOM SECTION: STUDENT DIRECTORY ─────────────────── */}
        ...
        <div className="glass-panel rounded-3xl p-5 border border-slate-800 space-y-4">
          ...
          <form method="get" className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3">
            ...
            <div className="md:col-span-5 flex justify-end">
              <button
                type="submit"
                className="rounded-xl bg-indigo-600/30 border border-indigo-500/40 px-5 py-2 text-xs font-bold text-indigo-300 hover:bg-indigo-600/40 transition-all cursor-pointer"
              >
                Apply Filters
              </button>
            </div>
            ...
            <table className="w-full text-left text-xs text-slate-300">
              <thead className="bg-slate-900/90 text-[10px] font-bold uppercase tracking-wider text-slate-400 border-b border-slate-800">
                <tr>
                  ...
                  <th className="px-5 py-4">Verified Certificates</th>
                    ...
                    <td className="px-5 py-4 text-right">
                      <div className="inline-flex items-center justify-end gap-2">
                        ...
                        <Link
                          ...
                          className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-slate-800/90 border border-slate-700 text-cyan-300 font-bold text-xs hover:bg-slate-700 transition-all"
                        >
